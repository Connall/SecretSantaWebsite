<?php
$api_key = "yourkeyhere"; // Your Steam WebAPI-Key found at http://steamcommunity.com/dev/apikey
$domainname = "yourdomainname"; // The main URL of your website displayed in the login page
